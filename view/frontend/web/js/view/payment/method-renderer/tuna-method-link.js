let tunaLibLink;
let methodLink = "LinkOnly";
if (window.checkoutConfig.payment.tunagateway.useSandboxBundle)
tunaLibLink = "tuna_essential_sandbox";
else
tunaLibLink = "tuna_essential";
...
define(
    ...
    function (tuna_essential, tuna_checkout_info, alert, $, quote, Component, setPaymentInformationAction, placeOrder, priceUtils) {
        ...
        require(['jquery', 'jquery_mask'], function ($) {
            ...
            $('#div'+methodLink + ' #tuna_credit_card_document').mask(CpfCnpjMaskBehavior, cpfCnpjpOptions);
            $("#div"+methodLink + " #tuna_first_credit_card_value").mask("9999999999,99");
            $("#div"+methodLink + " #tuna_second_credit_card_value").mask("999999999,99");
            $("#div"+methodLink + " #tuna_credit_card_code").mask("999");
            $("#div"+methodLink + " #tuna_second_credit_card_code").mask("999");
            $("#div"+methodLink+ " CcCvv").mask("999");
            $("#div"+methodLink + " #tuna_credit_card_number").mask("9999 9999 9999 9999");
            $("#div"+methodLink + " #tuna_second_credit_card_number").mask("9999 9999 9999 9999");
            $("#div"+methodLink + " #tuna_billing_address_zip").mask("99.999-999");

            $('#div'+methodLink + ' #tuna_billing_address_phone').mask('(00) 0000-00009');

            $("#div"+methodLink + " #tuna_billing_address_phone").live("blur", function (event) {
                if ($(this).val().length == 15) {
                    $('#div'+methodLink + ' #tuna_billing_address_phone').mask('(00) 00000-0009');
                } else {
                    $('#div'+methodLink + ' #tuna_billing_address_phone').mask('(00) 0000-00009');
                }
            });
        ...
        $('input[type=radio][name=billingAddress]').live("change", function () {
            $("#div"+methodLink + " #billingAddressFields").hide();
        });

        function fillInstallmentsSelector() {
            const firstCreditCardValue = parseFloat($("#div"+methodLink + " #tuna_first_credit_card_value").val().replace(',', '.')).toFixed(2);
            const secondCreditCardValue = parseFloat($("#div"+methodLink + " #tuna_second_credit_card_value").val().replace(',', '.')).toFixed(2);

            $('#div'+methodLink + ' #tuna_first_credit_card_installments').empty();
            $.each(getInstallments(firstCreditCardValue), function (i, item) {
                $('#div'+methodLink + ' #tuna_first_credit_card_installments').append($('<option>', {
                    value: item.value,
                    text: item.text
                }));
            });
            $('#div'+methodLink + ' #tuna_second_credit_card_installments').empty();
            $.each(getInstallments(secondCreditCardValue), function (i, item) {
                $('#div'+methodLink + ' #tuna_second_credit_card_installments').append($('<option>', {
                    value: item.value,
                    text: item.text
                }));
            });
        ...
        function onPayWithTwoCardsValuesChanges(cardValueIndex) {
            ...
            if (cardValueIndex == 1) {
                changedFieldID = "#div"+methodLink + " #tuna_first_credit_card_value";
                otherFieldID = "#div"+methodLink + " #tuna_second_credit_card_value";
            } else {
                changedFieldID = "#div"+methodLink + " #tuna_second_credit_card_value";
                otherFieldID = "#div"+methodLink + " #tuna_first_credit_card_value";
            }
        ...
        $('#div'+methodLink + ' #tuna_first_credit_card_value').live("blur", _ => onPayWithTwoCardsValuesChanges(1));
        $('#div'+methodLink + ' #tuna_second_credit_card_value').live("blur", _ => onPayWithTwoCardsValuesChanges(2));

        $('#div'+methodLink + ' #tuna_first_credit_card_installments').live("change", _ => refreshOrderInfo());
        $('#div'+methodLink + ' #tuna_second_credit_card_installments').live("change", _ => refreshOrderInfo());

        function secondCardRadioChanged() {
            if ($("#div"+methodLink + " #tuna_second_card_radio_saved").prop("checked")) {
                $("#div"+methodLink + " #secondNewCardDiv").hide();
                $("#div"+methodLink + " #secondSavedCardDiv").show();
            } else {
                $("#div"+methodLink + " #secondSavedCardDiv").hide();
                $("#div"+methodLink + " #secondNewCardDiv").show();
            }
        };

        function cardRadioChanged() {
            if ($("#div"+methodLink + " #tuna_card_radio_saved").prop("checked")) {
                DisableAllMethods();
                $("#div"+methodLink + " #creditCardPaymentDiv").show();
                $("#div"+methodLink + " #lblHolderNameCard").show();
                $("#div"+methodLink + " #savedCardDiv").show();            
                $('#div'+methodLink + ' #tuna_credit_card_document').show();
                $('#div'+methodLink + ' #cpfCnpjDiv').show();
                $('#div'+methodLink + ' #tuna_credit_card_installments').prop('selectedIndex', 1);
                refreshOrderInfo();
            } else if ($("#div"+methodLink + " #tuna_card_radio_new").prop("checked")) {
                DisableAllMethods();
                $("#div"+methodLink + " #creditCardPaymentDiv").show();                
                $("#div"+methodLink + " #lblHolderNameCard").show();
                $("#div"+methodLink + " #newCardDiv").show();                
                $('#div'+methodLink + ' #tuna_credit_card_document').show();
                $('#div'+methodLink + ' #cpfCnpjDiv').show();
                $('#div'+methodLink + ' #tuna_credit_card_installments').prop('selectedIndex', 1);
                refreshOrderInfo();
            } else if ($("#div"+methodLink + " #tuna_crypto_radio").prop("checked")) {
                DisableAllMethods();
                $("#div"+methodLink + " #cryptoDiv").show(); 
                resetOrderInfo();
            } else if ($("#div"+methodLink + " #tuna_pix_radio").prop("checked")) {
                DisableAllMethods();
                $("#div"+methodLink + " #pixDiv").show(); 
                resetOrderInfo();
            } else if ($("#div"+methodLink + " #tuna_link_radio").prop("checked")) {
                DisableAllMethods();
                $("#div"+methodLink + " #linkDiv").show(); 
                resetOrderInfo();
            } else {
                DisableAllMethods();                
                $('#div'+methodLink + ' #cpfCnpjDiv').show();
                $("#div"+methodLink + " #lblHolderNameBoleto").show();
                $('#div'+methodLink + ' #tuna_credit_card_document').show();                
                $("#div"+methodLink + " #boletoDiv").show();
                $("#div"+methodLink+ " checkout").html("Gerar boleto");
                resetOrderInfo();
            }
        };

        function payUsingTwoCardsClicked() {
            if ($("#div"+methodLink + " #payingWithTwoCards").val() === "0") {
                // Pay with two cards
                const savedCards = window.checkoutConfig.payment.tunagateway.savedCreditCards;
                $("#div"+methodLink + " #secondCardSelectorDiv").show();
                if (!savedCards || savedCards.length == 0) {
                    $("#div"+methodLink + " #tuna_second_savedCard_label").remove();
                    $("#div"+methodLink + " #tuna_second_new_card_radio").prop("checked", true);
                    $("#div"+methodLink + " #secondNewCardDiv").show();
                } else {
                    $("#div"+methodLink + " #tuna_second_card_radio_saved").prop("checked", true);
                    $("#div"+methodLink + " #secondSavedCardDiv").show();
                }
                $("#div"+methodLink + " #payingWithTwoCards").val("1");
                $("#div"+methodLink + " #payUsingTwoCardsLink").text("Pagar usando um cartão");
                $("#div"+methodLink + " #installmentsDiv").hide();

                const valuePerCard = (getOrderTotal() / 2).toFixed(2);
                $("#div"+methodLink + " #tuna_second_credit_card_value").val(valuePerCard.toString().replace('.', ','));
                $("#div"+methodLink + " #firstCardValueDiv").show();
                $("#div"+methodLink + " #first_card_installments_div").show();
                $("#div"+methodLink + " #tuna_first_credit_card_value").val((valuePerCard * 2 == getOrderTotal() ? valuePerCard : valuePerCard + 0.01).toString().replace('.', ','));

                fillInstallmentsSelector();
            } else {
                // Pay with one card
                $("#div"+methodLink + " #payingWithTwoCards").val("0");
                $("#div"+methodLink + " #installmentsDiv").show();
                $("#div"+methodLink + " #first_card_installments_div").hide();
                $("#div"+methodLink + " #secondCardSelectorDiv").hide();
                $("#div"+methodLink + " #firstCardValueDiv").hide();
                $("#div"+methodLink + " #payUsingTwoCardsLink").text("Pagar usando dois cartões");
                resetOrderInfo();
            }
        };

        $("#div"+methodLink + " #tuna_card_radio_new").live("change", cardRadioChanged);
        $("#div"+methodLink + " #tuna_card_radio_saved").live("change", cardRadioChanged);
        $("#div"+methodLink + " #tuna_boleto_radio").live("change", cardRadioChanged);
        $("#div"+methodLink + " #tuna_crypto_radio").live("change", cardRadioChanged);
        $("#div"+methodLink + " #tuna_pix_radio").live("change", cardRadioChanged);
        $("#div"+methodLink + " #tuna_link_radio").live("change", cardRadioChanged);
        $("#div"+methodLink + " #tuna_second_card_radio_saved").live("change", secondCardRadioChanged);
        $("#div"+methodLink + " #tuna_second_new_card_radio").live("change", secondCardRadioChanged);
        $("#div"+methodLink + " #payUsingTwoCardsLink").live("click", payUsingTwoCardsClicked);
        $('#div'+methodLink + ' #tuna').live("change", () => {
            $("#div"+methodLink + " #tuna_credit_card_installments").prop('selectedIndex', 1);
            refreshOrderInfo();
        });
        $("#div"+methodLink + " #checkmo").live("click", resetOrderInfo);
        $("#div"+methodLink + " #tuna_credit_card_installments").live("change", () => {
            if ($("#div"+methodLink + " #tuna").prop("checked")) {
                refreshOrderInfo();
            } else {
                resetOrderInfo();
            }
        ...
        function DisableAllMethods(){ 
            $("#div"+methodLink + " #savedCardDiv").hide();
            $("#div"+methodLink + " #creditCardPaymentDiv").hide();
            $("#div"+methodLink + " #lblHolderNameBoleto").hide();
            $("#div"+methodLink + " #lblHolderNameCard").hide();
            $('#div'+methodLink + ' #tuna_credit_card_document').hide();
            $('#div'+methodLink + ' #cpfCnpjDiv').hide();
            $("#div"+methodLink + " #newCardDiv").hide();
            $("#div"+methodLink + " #cryptoDiv").hide();                        
            $("#div"+methodLink + " #boletoDiv").hide();
            $("#div"+methodLink + " #pixDiv").hide();
            $("#div"+methodLink + " #linkDiv").hide();
            $("#div"+methodLink+ " checkout").html("Pagar");
        }
        function getOrderTotal() {
            return parseFloat(quote.getTotals()()['total_segments'][quote.getTotals()()['total_segments'].length - 1].value, 10);
        }

        $("#div"+methodLink + " #tuna_billing_address_country").live("change", _ => {
            // Fix unknown info
            if ($("#div"+methodLink + " #control").length == 1) {
                $("#div"+methodLink + " #control").remove();
                $("#div"+methodLink + " #tuna_billing_address_country").val("BR");
            }

            let selectCountryID = $("#div"+methodLink + " #tuna_billing_address_country option:selected").val();
            let countryRegions = window.checkoutConfig.countries.find(c => c.id == selectCountryID).regions;
            $('#div'+methodLink + ' #tuna_billing_address_state').find('option').remove();
            countryRegions.forEach(region => {
                let option = new Option(region.name, region.id);
                $('#div'+methodLink + ' #tuna_billing_address_state').append(option);
            });
        });

        return Component.extend({
            defaults: {
                template: 'Tuna_TunaGateway/payment/link',
            },
            afterRender: function () {
                $('#div'+methodLink + ' #tuna').prop('checked', true);
                $("#div"+methodLink + " #lblTunaPaymentTitle").html(window.checkoutConfig.payment.tunagateway.title_link);
                if (!window.checkoutConfig.payment.tunagateway.sessionid) {
                    if (!this.allowBoleto()) {
                        $("#div"+methodLink + " #tuna_payment_method_content").remove();
                        $("#div"+methodLink + " #badNewsDiv").show();
                        return;
                    } else {
                        $("#div"+methodLink + " #creditCardPaymentDiv").remove();
                        $("#div"+methodLink + " #tuna_savedCard_label").remove();
                        $("#div"+methodLink + " #tuna_newCard_label").remove();
                        $("#div"+methodLink + " #cryptoDiv").remove();
                        $("#div"+methodLink + " #pixDiv").remove();
                        $("#div"+methodLink + " #linkDiv").remove();
                        $("#div"+methodLink + " #tuna_boleto_radio").prop("checked", true);
                        $("#div"+methodLink + " #boletoDiv").show();
                        return;
                    }
                }
                ...
                if (!this.allowBoleto()) {
                    $("#div"+methodLink + " #tuna_boleto_label").remove();
                    $("#div"+methodLink + " #boletoDiv").remove();
                }
                if (!this.allowCrypto()) {
                    $("#div"+methodLink + " #tuna_crypto_label").remove();
                    $("#div"+methodLink + " #cryptoDiv").remove();
                }
                if (!this.allowPix()) {
                    $("#div"+methodLink + " #tuna_pix_label").remove();
                    $("#div"+methodLink + " #pixDiv").remove();
                }
                if (!this.allowLink()) {
                    $("#div"+methodLink + " #tuna_link_label").remove();
                    $("#div"+methodLink + " #linkDiv").remove();
                }
                if (!this.allowCard()) {
                    $("#div"+methodLink + " #creditCardPaymentDiv").remove();
                    ...
                    if (this.allowPix()) {
                        this.disableAll();
                        $("#div"+methodLink + " #tuna_pix_radio").prop("checked", true);
                        $("#div"+methodLink + " #pixDiv").show();            
                    ...
                    }else
                    {
                        ...
                        }else
                        {
                            if (this.allowCrypto()) {
                                this.disableAll();
                                $("#div"+methodLink + " #tuna_cripto_radio").prop("checked", true);
                                $("#div"+methodLink + " #cryptoDiv").show(); 
                            }else
                            {if (this.allowLink()) {
                                this.disableAll();
                                $("#div"+methodLink + " #tuna_link_radio").prop("checked", true);
                                $("#div"+methodLink + " #linkDiv").show();            
                               
                            }else
                            {
                                this.disableAll();    
                                $("#div"+methodLink+ " checkout").hide();                            
                            }
                            }
                        }
                    }
                ...
                if (!this.allowPaymentWithTwoCards()) {
                    $("#div"+methodLink + " #payUsingTwoCardsLink").remove();
                }
                if (this.getStoredCreditCards() && this.getStoredCreditCards().length > 0) {
                    $("#div"+methodLink + " #tuna_card_radio_saved").prop("checked", true);
                    $("#div"+methodLink + " #savedCardDiv").show();
                } else {
                    $("#div"+methodLink + " #tuna_savedCard_label").remove();
                    $("#div"+methodLink + " #tuna_card_radio_new").prop("checked", true);
                    $("#div"+methodLink + " #newCardDiv").show();
                }
            },
            enableBillingAddressFields: function () {
                $("#div"+methodLink + " #billingAddressFields").show();
            ...
            isTunaActive: function () {                                
                return (window.checkoutConfig.payment.tunagateway.allow_link &&
                    window.checkoutConfig.payment.tunagateway.allow_link === "1") && !(window.checkoutConfig.payment.tunagateway.tuna_active &&
            ...
            selectStoredCard: function (paymentCardIndex, cc) {
                if (paymentCardIndex === 1) {
                    ...
                    $("#div"+methodLink + " #tuna_card_cvv_" + cc.token).show();
                }
                else {
                    $("input[id^='tuna_second_card_cvv_']").hide();
                    $("#div"+methodLink + " #tuna_second_card_cvv_" + cc.token).show();
                }
            },
            ...
            endOrder: function (self, creditCardData, secondCreditCardData, paymentData, messageContainer, isBoleto = false, isPix = false, isCrypto = false, isLink = false) {
                ...
                const additionalData = {
                    'buyer_document': $('#div'+methodLink + ' #tuna_credit_card_document').val(),
                    'session_id': window.checkoutConfig.payment.tunagateway.sessionid,
                    'credit_card_data': JSON.stringify(creditCards),
                    'buyer_name': isBoleto ? $('#div'+methodLink + ' #tuna_boleto_holder').val() : "",
            ...
            isUsingFirstSavedCard: function () {
                return $("#div"+methodLink + " #tuna_card_radio_saved").prop("checked");
            },
            isUsingSecondSavedCard: function () {
                return $("#div"+methodLink + " #tuna_second_card_radio_saved").prop("checked");
            },
            isUsingNewFirstCard: function () {
                return $("#div"+methodLink + " #tuna_card_radio_new").prop("checked");
            },
            isUsingNewSecondCard: function () {
                return $("#div"+methodLink + " #tuna_second_new_card_radio").prop("checked");
            },
            isUsingTwoCards: function () {
                return $("#div"+methodLink + " #payingWithTwoCards").val() === "1";
            },
            isBoletoPayment: function () {
                return $("#div"+methodLink + " #tuna_boleto_radio").prop("checked");
            },
            isCryptoPayment: function () {
                return $("#div"+methodLink + " #tuna_crypto_radio").prop("checked");
            },
            isPixPayment: function () {
                return $("#div"+methodLink + " #tuna_pix_radio").prop("checked");
            },
            isLinkPayment: function () {
                return $("#div"+methodLink + " #tuna_link_radio").prop("checked");
            },
            ...
            validateFirstNewCardData: function () {
                if (!$('#div'+methodLink + ' #tuna_credit_card_holder')[0].value)
                    return "holderInvalidInfo";

                let cardNumber = this.onlyNumbers($('#div'+methodLink + ' #tuna_credit_card_number')[0].value);
                if (!cardNumber || !valid_credit_card(cardNumber))
                    return "creditCardInvalidInfo";

                let expirationYear = $('#div'+methodLink + ' #tuna_credit_card_expiration_year')[0].value;
                let expirationMonth = $('#div'+methodLink + ' #tuna_credit_card_expiration_month')[0].value;
                ...
                if (!$("#div"+methodLink + " #tuna_credit_card_code")[0].value || $("#div"+methodLink + " #tuna_credit_card_code")[0].value < 3)
                    return "cvvInvalidInfo";
            },
            validateSecondNewCardData: function () {
                if (!$('#div'+methodLink + ' #tuna_second_credit_card_holder')[0].value)
                    return "secondHolderInvalidInfo";

                let cardNumber = this.onlyNumbers($('#div'+methodLink + ' #tuna_second_credit_card_number')[0].value);
                if (!cardNumber || !valid_credit_card(cardNumber))
                    return "secondCreditCardInvalidInfo";

                let expirationYear = $('#div'+methodLink + ' #tuna_second_credit_card_expiration_year')[0].value;
                let expirationMonth = $('#div'+methodLink + ' #tuna_second_credit_card_expiration_month')[0].value;
                ...
                if (!$("#div"+methodLink + " #tuna_second_credit_card_code")[0].value || $("#div"+methodLink + " #tuna_second_credit_card_code")[0].value < 3)
                    return "secondCvvInvalidInfo";
            },
            validateFirstSavedCardData: function () {
                if ($("input[name='firstStoredCard']:checked").length > 0) {
                    if (!$("#div"+methodLink + " #tuna_card_cvv_" + this.getSelectedCardToken(1)).val())
            ...
            isFieldsValid: function () {
                if (this.isUsingTwoCards()) {
                    ...
                    if (!$('#div'+methodLink + ' #tuna_boleto_holder')[0].value)
                ...
                let document = $('#div'+methodLink + ' #tuna_credit_card_document')[0].value;
            ...
            placeOrder: async function () {
                if ($("#div"+methodLink + " #customer-email").val() == "" && $("#div"+methodLink+ " authentication-wrapper").css("display") == "block") {
                    alert({
                        title: $.mage.__('Algo deu errado'),
                ...
                if (!fieldCheckResponse) {
                    if (this.isUsingTwoCards()) {
                        ...
                        if (this.isUsingFirstSavedCard()) {
                            ...
                            const cardData = {
                                CardHolderName: $('#div'+methodLink + ' #tuna_credit_card_holder').val(),
                                CardNumber: this.onlyNumbers($('#div'+methodLink + ' #tuna_credit_card_number').val()),
                                ExpirationMonth: parseInt($('#div'+methodLink + ' #tuna_credit_card_expiration_month').val()),
                                ExpirationYear: parseInt($('#div'+methodLink + ' #tuna_credit_card_expiration_year').val()),
                                Cvv: $('#div'+methodLink + ' #tuna_credit_card_code').val()
                            };
                        ...
                        if (this.isUsingSecondSavedCard()) {
                            ...
                            const cardData = {
                                CardHolderName: $('#div'+methodLink + ' #tuna_second_credit_card_holder').val(),
                                CardNumber: this.onlyNumbers($('#div'+methodLink + ' #tuna_second_credit_card_number').val()),
                                ExpirationMonth: parseInt($('#div'+methodLink + ' #tuna_second_credit_card_expiration_month').val()),
                                ExpirationYear: parseInt($('#div'+methodLink + ' #tuna_second_credit_card_expiration_year').val()),
                                Cvv: $('#div'+methodLink + ' #tuna_second_credit_card_code').val()
                            };
                        ...
                        firstCreditCardData.amount = parseFloat($("#div"+methodLink + " #tuna_first_credit_card_value").val().replace(',', '.')).toFixed(2);
                        firstCreditCardData.installments = parseInt($('#div'+methodLink + ' #tuna_first_credit_card_installments option:selected').val());

                        secondCreditCarData.amount = parseFloat($("#div"+methodLink + " #tuna_second_credit_card_value").val().replace(',', '.')).toFixed(2);
                        secondCreditCarData.installments = parseInt($('#div'+methodLink + ' #tuna_second_credit_card_installments option:selected').val());
                        ...
                        if (creditCardData) {
                            ...
                            creditCardData.installments = parseInt($('#div'+methodLink + ' #tuna_credit_card_installments').val() || "1");
                    ...
                    validationLabels.forEach(fieldID => {
                        $("#div"+methodLink + " #" + fieldID).hide();
                    });

                    $("#div"+methodLink + " #" + fieldCheckResponse).show();
                }
            }
        });
    }
